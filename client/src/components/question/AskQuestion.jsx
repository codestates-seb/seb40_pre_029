...
const Ask = () => {
  ...
  return (
    <div className="flex flex-col bg-#F8F9F9 w-2/5 m-4">
      <section>
        <form
          className="question-title-container border-2 border-#E3E6E8  mb-12 rounded"
        ...
        <form className="border-2 border-#E3E6E8  mb-12 rounded">
          <div className="p-4 bg-#FFFFFF ">
