  ...
  return (
    <>
      <div className="flex fixed inset-0 bg-gray-600 bg-opacity-80 h-full w-full z-40 justify-center items-center">
        <div className="flex justify-center items-center z-50" ref={userMenu}>
          <form
            className="flex flex-col lg:w-[30rem] lg:h-[40rem] z-0 space-y-4 border-4 bg-white p-2 justify-around items-center rounded-md"
            onSubmit={createID}>
            <div className="flex flex-col">
              ...
              <div>
                ...
                <label htmlFor="pwview" className="text-sm">
                  비밀번호를 표시합니다.
                </label>
              </div>
            </div>
            <div className="flex justify-center items-end">
              <button
                className="px-6 pb-1 shadow-sky-300 shadow-tline border border-sky-500 hover:bg-sky-500 h-12 w-40 min-w-36 bg-blue-500 rounded text-white"
                type="submit"
