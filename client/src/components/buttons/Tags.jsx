...
export default function Tags({ tag, onClick }) {
  return (
    <button
      onClick={onClick}
      className="group/tag text-sm flex items-center justify-between w-full bg-white py-1 pr-2 pl-1 rounded mb-1 border border-gray-300 hover:bg-green-200 text-gray-500">
      <span
        className={
          tag.select
